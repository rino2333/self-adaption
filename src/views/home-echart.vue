...
import headerSvg from "@/assets/images/123.jpg";
...
onMounted(() => {
  const myChart = echarts.init(chartRefs.value[0] as HTMLElement);
  const option = {
    grid: {
        top: 0,
        right: 0,
    ...
    series: [
        ...
        {
            name:'dashboard.Registration volume',
  ...
  const myChart2 = echarts.init(chartRefs.value[1] as HTMLElement);
  const myChart3 = echarts.init(chartRefs.value[2] as HTMLElement);
  const myChart4 = echarts.init(chartRefs.value[3] as HTMLElement);
  const option2 = {
        grid: {
            top: 30,
            right: 0,
        ...
        radar: {
            indicator: [
                ...
                { name: 'dashboard.Compressed package' },
            ],
        },
        series: (function () {
            var series = []
    ...
    const option3 = {
        ...
        xAxis: {
            data: ['dashboard.Baidu', 'dashboard.Direct access', 'dashboard.take a plane', 'dashboard.Take the high-speed railway'],
            axisTick: { show: false },
            axisLine: { show: false },
            axisLabel: {
                color: '#e54035',
        ...
        <el-row :gutter="20">
            <el-col :sm="12" :lg="6">
                <div class="small-panel user-reg suspension">
                    <div class="small-panel-title">系统总用户数</div>
            ...
            <el-col :sm="12" :lg="6">
                <div class="small-panel file suspension">
                    <div class="small-panel-title">在线用户数</div>
                    <div class="small-panel-content">
                        <div class="content-left">
            ...
            <el-col :sm="12" :lg="6">
                <div class="small-panel users suspension">
                    <div class="small-panel-title">毕业生总数</div>
                    <div class="small-panel-content">
                        <div class="content-left">
            ...
            <el-col :sm="12" :lg="6">
                <div class="small-panel addons suspension">
                    <div class="small-panel-title">留级总数</div>
                    <div class="small-panel-content">
                        <div class="content-left">
    ...
    <div class="growth-chart">
        <el-row :gutter="20">
            <el-col class="lg-mb-20" :xs="24" :sm="24" :md="12" :lg="9">
                <el-card shadow="hover" header="学生增长情况">
                    <div class="user-growth-chart" :ref="chartRefs.set"></div>
                </el-card>
            </el-col>
            <el-col class="lg-mb-20" :xs="24" :sm="24" :md="12" :lg="9">
                <el-card shadow="hover" header="课件学习情况">
                    <div class="file-growth-chart" :ref="chartRefs.set"></div>
                </el-card>
            </el-col>
            <el-col :xs="24" :sm="24" :md="24" :lg="6">
                <el-card class="new-user-card" shadow="hover" header="成员通知">
                    <div class="new-user-growth">
                        <el-scrollbar>
                            <div class="new-user-item">
                                <img class="new-user-avatar" src="../assets/images/123.jpg" alt="" />
                                <div class="new-user-base">
                                    <div class="new-user-name">张三</div>
                                    <div class="new-user-time">12分钟前加入我们</div>
                                </div>
                            ...
                            <div class="new-user-item">
                                <img class="new-user-avatar" src="../assets/images/123.jpg" alt="" />
                                <div class="new-user-base">
                                    <div class="new-user-name">李四</div>
                                    <div class="new-user-time">12分钟前加入我们</div>
                                </div>
                                <Icon class="new-user-arrow" color="#8595F4" name="fa fa-angle-right" />
                            </div>
                            <div class="new-user-item">
                                <img class="new-user-avatar" src="../assets/images/123.jpg" alt="" />
                                <div class="new-user-base">
                                    <div class="new-user-name">王五</div>
                                    <div class="new-user-time">12分钟前加入我们</div>
                                </div>
                                <Icon class="new-user-arrow" color="#8595F4" name="fa fa-angle-right" />
                            </div>
    ...
    <div class="growth-chart">
        <el-row :gutter="20">
            <el-col class="lg-mb-20" :xs="24" :sm="24" :md="24" :lg="12">
                <el-card shadow="hover" header="会员成员">
                    <div class="user-source-chart" :ref="chartRefs.set"></div>
                </el-card>
            </el-col>
            <el-col class="lg-mb-20" :xs="24" :sm="24" :md="24" :lg="12">
                <el-card shadow="hover" header="会员形式">
